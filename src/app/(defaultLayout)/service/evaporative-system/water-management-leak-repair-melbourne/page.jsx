...
export async function generateMetadata() {
  const serviceData = evaporativeSystemData.find(
    (service) => service.slug === "water-management-leak-repair-melbourne"
  );
  ...
  return {
    ...
    keywords:
      "evaporative water management Melbourne, water leak repair, drainage solutions, water line repair, overflow prevention, water quality management",
    openGraph: {
      title: serviceData.metaTitle,
      description: serviceData.metaDescription,
    ...
    alternates: {
      canonical:
        "/service/evaporative-system/water-management-leak-repair-melbourne",
    },
  };
}
