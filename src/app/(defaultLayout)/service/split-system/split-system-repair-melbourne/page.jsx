...
export async function generateMetadata() {
  const serviceData = splitSystemData.find(
    (service) => service.slug === "split-system-repair-melbourne"
  );
  ...
  return {
    ...
    keywords:
      "split system repair melbourne, air conditioning repair, aircon repair melbourne, split system fix, emergency aircon repair melbourne",
    openGraph: {
      title: serviceData.metaTitle,
      description: serviceData.metaDescription,
    ...
    alternates: {
      canonical: "/service/split-system/split-system-repair-melbourne",
    },
  };
}
