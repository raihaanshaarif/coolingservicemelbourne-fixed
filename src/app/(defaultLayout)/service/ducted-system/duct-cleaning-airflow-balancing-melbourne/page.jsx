...
export async function generateMetadata() {
  const serviceData = ductedSystemData.find(
    (service) => service.slug === "duct-cleaning-airflow-balancing-melbourne"
  );
  ...
  return {
    ...
    keywords:
      "duct cleaning melbourne, airflow balancing melbourne, duct cleaning service, air duct cleaning melbourne, ductwork cleaning melbourne",
    openGraph: {
      title: serviceData.metaTitle,
      description: serviceData.metaDescription,
    ...
    alternates: {
      canonical:
        "/service/ducted-system/duct-cleaning-airflow-balancing-melbourne",
    },
  };
}
