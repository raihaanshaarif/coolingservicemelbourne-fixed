...
import data from "../../Data/evaporativeSystemServices.json";

const EvaporativeSystemServices = () => {
  return (
    <section>
              ...
              <div className="cs_card cs_style_1">
                ...
                <div className="cs_card_info cs_white_bg cs_radius_10 text-center">
                  ...
                  <h3 className="cs_card_title cs_fs_30 cs_mb_8">
                    <Link href={`/service/evaporative-system/${service.slug}`}>
                      {service.title}
                    </Link>
                  </h3>
                  ...
                  <Link
                    href={`/service/evaporative-system/${service.slug}`}
...
export default EvaporativeSystemServices;
