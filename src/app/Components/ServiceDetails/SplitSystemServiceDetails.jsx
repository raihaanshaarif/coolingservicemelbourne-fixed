...
const SplitSystemServiceDetails = ({ serviceData }) => {
                ...
                <div className="cs_card_content p-4 p-lg-5 position-relative">
                  <div className="text-center cs_mb_40">
                    ...
                    <h4
                      ...
                      data-wow-delay="0.1s"
                    >
                      We Service All Split System Types
                    </h4>
                    <p
            ...
            <div className="cs_sidebar cs_style_1">
              <div className="cs_sidebar_widget cs_accent_bg_light position-relative">
                ...
                <ul className="cs_categories cs_fs_18 cs_semibold cs_mp_0">
                  <li>
                    <Link href="/service/split-system/split-system-installation-melbourne">
                      <span>Split System Installation</span>
                      <span>
                  ...
                  <li>
                    <Link href="/service/split-system/split-system-repair-melbourne">
                      <span>Split System Repair</span>
                      <span>
                        <i className="bi bi-arrow-right"></i>
                      </span>
                    </Link>
                  ...
                  <li>
                    <Link href="/service/split-system/emergency-split-system-repairs-melbourne">
...
export default SplitSystemServiceDetails;
